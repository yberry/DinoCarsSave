...
public class PseudoVolumetricExplosion : MonoBehaviour {
	...
	public float ActualLoopDuration { get { return loopDuration * timeScale; } }
	public float ActualLoopOffset { get { return loopOffset *timeScale; } }
	...
	void Update () {
		...
		float pos = (ActualLoopOffset + timeFromBegin) / ActualLoopDuration;
