...
{
    [ExecuteInEditMode]
    public class CarFollowCam : UnityStandardAssets.Cameras.PivotBasedCameraRig
    {
        ...
        [SerializeField] private bool m_FollowTarget = false;// Whether the rig will rotate in the direction of the target's velocity.
